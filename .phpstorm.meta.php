...
'auth.passwords.users.throttle','auth.password_timeout','blade-icons.sets','blade-icons.class','blade-icons.attributes',
'blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','blade-tabler-icons.prefix','blade-tabler-icons.fallback',
'blade-tabler-icons.class','blade-tabler-icons.attributes','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'hashing.rehash_on_login','view.paths','view.compiled','concurrency.default','broadcasting.default',
...
'broadcasting.connections.ably.driver','broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','debugbar.enabled',
...
'debugbar.queries.explain','login','login.store','logout',
'home','dashboard','simulation','drag-drop-test','storage.local',);
        registerArgumentsSet('views', 
'components.button','components.card','components.dashboard-layout','components.input','components.input-error',
'components.label','components.nav','components.nav-item','components.nav-section','components.select',
'components.sim-component','components.sim-component-category','components.sim-component-group','components.sim-components-library','components.sim-effect',
'components.sim-effects-list','components.sim-grid','components.sim-grid-tile','components.table','components.table-data',
'components.table-head','components.table-row','components.textarea','dashboard','drag-drop-test',
'layouts.base','layouts.card','login','simulation','laravel-exceptions-renderer::components.card',
