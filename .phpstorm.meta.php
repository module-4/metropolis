...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'blade-tabler-icons.prefix' => 'string',
            'blade-tabler-icons.fallback' => 'string',
            'blade-tabler-icons.class' => 'string',
            'blade-tabler-icons.attributes' => 'array',
...
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','blade-icons.sets',
...
'blade-tabler-icons.prefix','blade-tabler-icons.fallback','blade-tabler-icons.class','blade-tabler-icons.attributes','cache.default',
...
'broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','debugbar.enabled','debugbar.hide_empty_tabs',
...
'debugbar.queries.explain','sanctum.csrf-cookie','login',
'login.store','logout','home','dashboard','simulation',
'component-effect-management','component-effect-management-update','component-manager','component-store','components.edit',
'components.update','components.destroy','blocklist.index','blocklist.create','blocklist.destroy',
'blocklist.store','reports.show','events.index','events.create','events.store',
'events.show','events.edit','events.update','events.destroy','comments.store',
'storage.local',);
        registerArgumentsSet('views', 
'blocklist.create','blocklist.index','component-effect-management','component-manager','component-manager-edit',
'components.button','components.card','components.comment-section-form','components.component-effect-card','components.dashboard-layout',
'components.input','components.input-error','components.label','components.modal','components.nav',
'components.nav-item','components.nav-section','components.select','components.select-effect','components.sim-component',
'components.sim-component-group','components.sim-components-library','components.sim-controlbar','components.sim-effect','components.sim-effects-list',
'components.sim-grid','components.sim-grid-tile','components.table','components.table-data','components.table-head',
'components.table-row','components.textarea','components.triangle','dashboard','drag-drop-test',
'events.create','events.edit','events.index','layouts.base','layouts.card',
'login','pagination::default','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind',
'report','simulation','vendor.pagination.default','vendor.pagination.simple-default','vendor.pagination.simple-tailwind',
