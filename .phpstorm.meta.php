...
'cors.max_age','cors.supports_credentials','concurrency.default','broadcasting.default','broadcasting.connections.reverb.driver',
...
'debugbar.queries.explain','sanctum.csrf-cookie','login','login.store',
'logout','home','dashboard','simulation','component-effect-management',
'component-effect-management-update','component-manager','component-store','components.edit','components.update',
'components.destroy','blocklist.index','blocklist.create','blocklist.destroy','blocklist.store',
'reports.show','storage.local',);
        registerArgumentsSet('views', 
'blocklist.create','blocklist.index','component-effect-management','component-manager','component-manager-edit',
'components.button','components.card','components.component-effect-card','components.component-effect-row','components.dashboard-layout',
...
'components.sim-component-group','components.sim-components-library','components.sim-effect','components.sim-effects-list','components.sim-grid',
'components.sim-grid-tile','components.table','components.table-data','components.table-head','components.table-row',
'components.textarea','components.triangle','dashboard','drag-drop-test','layouts.base',
'layouts.card','login','pagination::default','pagination::simple-default','pagination::simple-tailwind',
'pagination::tailwind','report','simulation','vendor.pagination.default','vendor.pagination.simple-default',
